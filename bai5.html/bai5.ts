...
let lengthOfString: number = bienAny.length; // Có thể gây lỗi khi chạy vì không phải tất cả các kiểu dữ liệu đều có thuộc tính length
